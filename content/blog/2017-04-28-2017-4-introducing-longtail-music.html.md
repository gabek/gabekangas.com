...
---
```{=html} <iframe src="https://player.vimeo.com/video/214576527?wmode=opaque&amp;api=1" width="640" height="360" frameborder="0" title="Longtail Music Promo" webkitallowfullscreen mozallowfullscreen allowfullscreen> ``` ```{=html} </iframe> ``` It\'s no secret I\'ve been frustrated with music discovery for a while.  Ever since [Rdio shut down](http://gabekangas.com/blog/goodbye-rdio) I\'ve listened to less music on mainstream services.  While I do have a [Spotify account](https://open.spotify.com/user/gabek), I tend to only use it to listen to old playlists and comfort music.
